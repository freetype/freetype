...
FT_BEGIN_HEADER
  ...
  FT_LOCAL const FT_UShort  cff_isoadobe_charset[229];
  
  FT_LOCAL const FT_UShort  cff_expert_charset[166];
  
  FT_LOCAL const FT_UShort  cff_expertsubset_charset[87];
  
  FT_LOCAL const FT_UShort  cff_standard_encoding[256];

  FT_LOCAL const FT_UShort  cff_expert_encoding[256];

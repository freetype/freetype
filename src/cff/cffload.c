...
#define FT_COMPONENT  trace_cffload
  ...
  FT_LOCAL_DEF const FT_UShort  cff_isoadobe_charset[229] =
  {
    0,
    1,
    2,
  ...
  FT_LOCAL_DEF const FT_UShort  cff_expert_charset[166] =
  {
    0,
    1,
    229,
  ...
  FT_LOCAL_DEF const FT_UShort  cff_expertsubset_charset[87] =
  {
    0,
    1,
    231,
  ...
  FT_LOCAL_DEF const FT_UShort  cff_standard_encoding[256] =
  {
    0,
    0,
    0,
  ...
  FT_LOCAL_DEF const FT_UShort  cff_expert_encoding[256] =
  {
    0,
    0,
    0,
